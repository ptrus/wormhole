...
contract("Wormhole", function() {
  ...
  it("should log a published message correctly", async function() {
    ...
    console.log("got logs:", log.events);
    assert.equal(
  ...
  it("should set and enforce fees", async function() {
    ...
    let data =
      "0x00000000000000000000000000000000000000000000000000000000436f726503";
    ...
    let nonce0 = await web3.eth.getTransactionCount(accounts[0], "pending");
    console.log("nonce now:", nonce0);
    ...
    let nonce1 = await web3.eth.getTransactionCount(accounts[0], "pending");
    console.log("nonce before 2nd:", nonce1);
    ...
    try {
      ...
      console.log("failed hehe", e);
      failed = true;
    }

    let nonce2 = await web3.eth.getTransactionCount(accounts[0], "pending");
    console.log("nonce after failed:", nonce2);
  ...
  it("should transfer out collected fees", async function() {
    ...
    const emitterAddress = testGovernanceContract;
    let data =
      "0x00000000000000000000000000000000000000000000000000000000436f726504";
  ...
  it("should accept a new guardian set", async function() {
    ...
    const emitterAddress = testGovernanceContract;
    let data =
      "0x00000000000000000000000000000000000000000000000000000000436f726502";
    ...
    assert.ok(oldGuardians.expirationTime > Number(time));
  });
  ...
  it("should accept smart contract upgrades", async function() {
    ...
    const emitterAddress = testGovernanceContract;
    let data =
      "0x00000000000000000000000000000000000000000000000000000000436f726501";
    ...
    console.log("We're here, storage at before:", before);
    console.log("We're here implementeation addr:", Implementation.address);
  ...
  it("should revert governance packets from old guardian set", async function() {
    ...
    try {
      ...
      console.log("old packet accepted");
